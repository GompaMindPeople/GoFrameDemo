...
// arModel is a active record design model for table router_table operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of router_table.
	Table = "router_table"
	// Model is the model object of router_table.
