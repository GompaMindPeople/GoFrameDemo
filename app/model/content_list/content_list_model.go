...
// arModel is a active record design model for table content_list operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of content_list.
	Table = "content_list"
	// Model is the model object of content_list.
